...
import net.sunniwell.app.linktaro.launcher.bean.Parameter;

/* renamed from: net.sunniwell.app.linktaro.launcher.db.DbHelper */
public class DbHelper extends SQLiteOpenHelper {
    ...
    /* renamed from: ID */
    private static final String f324ID = "_id";
