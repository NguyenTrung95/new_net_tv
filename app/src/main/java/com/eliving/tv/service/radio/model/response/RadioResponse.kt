package com.eliving.tv.service.radio.model.response

import android.os.Parcel
import android.os.Parcelable
import com.eliving.tv.ext.optString
import com.eliving.tv.service.vod.model.response.VODResponse
...
open class RadioResponse()  : Parcelable{
    ...
    companion object CREATOR : Parcelable.Creator<RadioResponse> {
        override fun createFromParcel(parcel: Parcel): RadioResponse {
            return RadioResponse(parcel)
        }

        override fun newArray(size: Int): Array<RadioResponse?> {
