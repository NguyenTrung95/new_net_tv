...
open class VODResponse()  : Parcelable{
    ...
    companion object CREATOR : Parcelable.Creator<VODResponse> {
        override fun createFromParcel(parcel: Parcel): VODResponse {
            return VODResponse(parcel)
        }

        override fun newArray(size: Int): Array<VODResponse?> {
