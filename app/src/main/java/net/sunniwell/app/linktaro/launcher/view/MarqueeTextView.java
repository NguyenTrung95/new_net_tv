...
public class MarqueeTextView extends TextView implements Runnable, OnFocusChangeListener {
    ...
    public SWLogger LOG = SWLogger.getLogger(MarqueeTextView.class);
    ...
    Runnable startScrollRunnable = new Runnable() {
        public void run() {
            MarqueeTextView.this.LOG.mo8825d("-----startScrollRunnable----->run()");
    ...
    public void run() {
        ...
        if (this.scrollToX > this.contentWidth) {
            this.LOG.mo8825d("scrollToX > contentWidth");
