...
class PageDownLoad(context: Context?) : PageBase(context) {
    ...
    interface PageDownLoadCallBackListener {
        fun downLoadPageCallBack(i: Int, message: Message?)
        fun showInfoDialog()
    }
}